        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-serif text-foreground leading-[1.1] mb-8">
              Your readiness <br />
              is more than <br />
              <span className="text-[#5B2A86] italic">a CGPA.</span>
            </h2>
          ...
          >
            <div className="bg-white border border-border p-8 md:p-12">
              <div className="mb-10 pb-10 border-b border-border text-center relative">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-1 bg-[#F58220] rounded" />
                <div className="text-7xl font-serif text-[#5B2A86] mb-2 mt-6">82%</div>
                <div className="text-sm font-bold tracking-[0.2em] text-[#111111] uppercase">Overall Readiness Score</div>
              </div>
                ...
                {weights.map((w, i) => (
                  <div key={i}>
                    ...
                    <div className="h-1 w-full bg-[#f0f0ea] rounded-full overflow-hidden">
                      <div className="h-1 bg-[#5B2A86]" style={{ width: `${w.value}%` }} />
                    </div>
                  </div>
                ))}
              </div>
