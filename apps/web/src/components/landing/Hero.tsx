        ...
        <div className="grid lg:grid-cols-[1fr_1fr] gap-16 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-foreground leading-[1.1] mb-8">
              Turn placement <br />
              preparation into <br />
              <span className="text-accent italic pr-4">placement readiness.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="h-14 px-8 text-base bg-white border-foreground text-foreground hover:border-accent hover:text-accent rounded font-bold shadow-none transition-colors group" asChild>
          ...
          >
            <div className="bg-white border border-border shadow-2xl p-8 md:p-10 w-full relative z-10">
              ...
              <div className="border-b border-border pb-6 mb-8">
                ...
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-5xl font-serif text-accent">82%</span>
                </div>
              </div>
              ...
              <div className="mt-10 p-6 bg-[#f8f8f3] border border-border">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-xs font-bold bg-accent text-white px-3 py-1 uppercase tracking-widest">
                    Match: 78%
                  </span>
                </div>
                <div className="h-1 w-full bg-border mt-4">
                  <div className="h-1 bg-accent w-[78%]" />
                </div>
              </div>
            </div>
